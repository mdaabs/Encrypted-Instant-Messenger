...
**
** Created: Fri May 2 04:31:04 2014
...
static const char qt_meta_stringdata_TabDialog[] = {
    "TabDialog\0\0item\0newconvo(QListWidgetItem*)\0"
    "user\0receiveNewConvo(allUsers)\0"
    "delmytab(int)\0"
};
...
void TabDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->newconvo((*reinterpret_cast< QListWidgetItem*(*)>(_a[1]))); break;
        case 1: _t->receiveNewConvo((*reinterpret_cast< allUsers(*)>(_a[1]))); break;
