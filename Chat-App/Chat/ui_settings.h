...
public:
    ...
    void retranslateUi(QDialog *settings)
    {
        ...
        ip->setText(QApplication::translate("settings", "10.0.2.15", 0, QApplication::UnicodeUTF8));
        label_2->setText(QApplication::translate("settings", "Port", 0, QApplication::UnicodeUTF8));
        port->setText(QApplication::translate("settings", "6000", 0, QApplication::UnicodeUTF8));
